...
class Remove_Links_Scripts_Settings {
  ...
  private function remove_scripts_settings() {
    ...
    $remove_settings_emoji_svg_checked        = '';
    ...
    if ( isset( $remove_settings ) ) {
      ...
      if ( esc_attr( $remove_settings['emoji_svg'] ) == 'on' ) {
        $remove_settings_emoji_svg_checked = 'checked';
      }
      ...
      <form enctype="multipart/form-data" action="" method="POST" id="remove-links-and-scripts">
        ...
        <table class="remove-links-and-scripts">
          ...
          <tbody>
            ...
            <tr>
              <td><input type="checkbox" name="emoji_svg" value="on" <?php echo $remove_settings_emoji_svg_checked; ?> /><strong><?php _e( 'Remove Emoji svg', 'remove-links-and-scripts' ); ?></strong></td>
            </tr>
          </tbody>
        </table>
